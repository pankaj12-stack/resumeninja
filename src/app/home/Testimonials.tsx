...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. ResumeNinja’s auto format feature is a great help to ensure consistent format.",
    name: "Ms. Thomas",
    title: "Educator",
  },
  {
    ...
    quote:
      "I used ResumeNinja during my last job search and was invited to interview at top tech thanks to its slick yet professional resume design.",
    name: "Anna",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on ResumeNinja is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Vivian",
